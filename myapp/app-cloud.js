...
routesA4=require('./routes/router_A4')(app);
...
//  mongoose.connect('mongodb://admin:admin@192.168.1.6:27017/persona?authSource=admin',{ useNewUrlParser: true, useUnifiedTopology: true });
  mongoose.connect('mongodb://admin:admin@192.168.1.6:27017/cloud?authSource=admin', {useNewUrlParser: true, useUnifiedTopology: true});
...
app.listen(3000, function() {
  console.log("Node server running on http://ip_del_host:3000");
});
